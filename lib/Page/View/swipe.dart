...
typedef SwipeDirectionCallback = void Function(SwipeDirection direction, double dragExtend);
...
typedef ConfirmSwipeCallback = Future<bool> Function(SwipeDirection direction, double dragExtend);
...
class _SwipeableState extends State<Swipeable> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  Future<bool> _confirmStartSwipeAnimation() async {
    if (widget.confirmSwipe != null) {
      ...
      return widget.confirmSwipe!(direction, _dragExtent);
    }
    return true;
  }
  ...
  void _startSwipeAnimation() {
    ...
    final direction = _swipeDirection;
    widget.onSwipe(direction, _dragExtent);
