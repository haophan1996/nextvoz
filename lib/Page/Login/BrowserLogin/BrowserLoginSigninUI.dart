  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: InAppWebView(
        ...
        initialUrlRequest: URLRequest(url: Uri.parse('https://voz.vn/login/login')),
        onLoadStop: (controllers, uri) async {
          controller.html = (await controller.inAppWebViewController!.getHtml())!;
          if (controller.html!= ''){
            dom.Document doc = parser.parse(controller.html);
            print(doc.getElementsByTagName('html')[0].attributes['data-logged-in']);
