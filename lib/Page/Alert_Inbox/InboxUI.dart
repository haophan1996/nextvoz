        ...
        child: CupertinoButton(
          ...
          onPressed: () {
            if (GlobalController.i.inboxList.elementAt(index)['isUnread'] == 'true') {
              ...
              GlobalController.i.update(['inbox$index']);
            }
            Get.toNamed(Routes.View, arguments: [GlobalController.i.inboxList.elementAt(index)['title'], GlobalController.i.inboxList.elementAt(index)['linkInbox'], '', 1]);
          },
        ),
      );
    });
