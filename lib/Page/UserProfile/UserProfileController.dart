...
class UserProfileController extends GetxController {
  ...
  onInit() async {
    ...
    // data['title'] = 'Loading';
    // data['joined'] = 'Loading';
    // data['lastSeen'] = 'Loading';
    // data['messages'] = 'Loading';
    // data['reactionScore'] = 'Loading';
  }
  ...
  loadProfileUser() async {
    //GlobalController.i.url+data['linkProfileUser']
    //https://voz.vn/u/chobay1996s.1740158/
    print(GlobalController.i.url+data['linkProfileUser']);
    await GlobalController.i.getBodya(()=> onErrorLoad(),GlobalController.i.url+data['linkProfileUser'], false).then((value) {
      ...
      data['lastSeen'] = userProfile.getElementsByClassName('u-dt ')[1].text;
